  ...
  return (
    (<motion.div
      ...
      <motion.div
        ...
        {/* Profile Card */}
        <Card
          className="p-8 flex flex-col items-center text-center shadow-xl rounded-2xl backdrop-blur-lg bg-[#1E293B]/50 border border-[#1897F2]/20 overflow-hidden relative">
          <motion.div
            className="absolute inset-0 bg-gradient-to-r from-[#0890F8]/30 to-[#199FFF]/30"
            animate={{
          ...
          <motion.div
            ...
            <motion.div
              className="absolute inset-0 bg-gradient-to-r from-[#0890F8] to-[#199FFF] rounded-full shadow-lg"
              animate={{ rotate: 360 }}
              transition={{ duration: 20, repeat: Infinity, ease: "linear" }} />
            <img
              src="/placeholder.svg?height=256&width=256"
              alt="Profile"
              className="rounded-full relative z-10 w-full h-full object-cover border-4 border-gray-700 group-hover:border-blue-500 transition-colors duration-300" />
          </motion.div>
          <motion.h1
            className="text-4xl font-extrabold mb-2 text-transparent bg-clip-text bg-gradient-to-r from-[#0890F8] to-[#199FFF]"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          <motion.div
            ...
            <Button
              className="mt-6 bg-gradient-to-r from-[#0890F8] to-[#199FFF] hover:from-[#0890F8]/90 hover:to-[#199FFF]/90 text-white px-6 py-3 rounded-full text-lg font-semibold shadow-lg transition-all duration-300 hover:scale-105">
        ...
        <div className="space-y-8">
          {/* About Me */}
          <Card
            className="p-6 shadow-xl rounded-2xl backdrop-blur-lg bg-[#1E293B]/50 border border-[#1897F2]/20 overflow-hidden">
            <motion.div
              className="space-y-4"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
